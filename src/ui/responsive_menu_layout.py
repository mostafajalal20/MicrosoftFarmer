...
class ResponsiveMenuLayout(Row):
    def __init__(
        ...
        **kwargs,
        ...
        self.content_area = Column(page_contents, expand=True, scroll=ScrollMode.AUTO, auto_scroll=False)
...
def create_page(title: str = None, body: str = None, ctrls: list = None):
    return Row(
        controls=[
            Column(
